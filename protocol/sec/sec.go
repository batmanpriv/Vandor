...
import (
	...
	"github.com/batmanpriv/Vandor/protocol/lic"
...
func (o *RDPInfo) Serialize(hasExtended bool) []byte {
	buff := &bytes.Buffer{}
	core.WriteUInt32LE(o.CodePage, buff)                      
	core.WriteUInt32LE(o.Flag, buff)                          
	core.WriteUInt16LE(uint16(len(o.Domain)-2), buff)         
	core.WriteUInt16LE(uint16(len(o.UserName)-2), buff)       
	core.WriteUInt16LE(uint16(len(o.Password)-2), buff)       
	core.WriteUInt16LE(uint16(len(o.AlternateShell)-2), buff) 
	core.WriteUInt16LE(uint16(len(o.WorkingDir)-2), buff)     
...
func (c *Client) sendClientRandom() {
	...
	ret, _ := rsa.EncryptPKCS1v15(rand.Reader, serverPubKey, core.Reverse(clientRandom))
...
func (c *Client) sendClientNewLicenseRequest(data []byte) {
	...
	ret, _ := rsa.EncryptPKCS1v15(rand.Reader, serverPubKey, core.Reverse(preMasterSecret))
