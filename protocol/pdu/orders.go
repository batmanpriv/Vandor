...
const (
	ORDER_TYPE_DSTBLT     = 0x00 
	ORDER_TYPE_PATBLT     = 0x01 
	ORDER_TYPE_SCRBLT     = 0x02 
	ORDER_TYPE_LINETO     = 0x09 
	ORDER_TYPE_OPAQUERECT = 0x0A 
	ORDER_TYPE_SAVEBITMAP = 0x0B 
	ORDER_TYPE_MEMBLT     = 0x0D 
	ORDER_TYPE_MEM3BLT    = 0x0E 
	ORDER_TYPE_POLYGON_SC = 0x14 
	ORDER_TYPE_POLYGON_CB = 0x15 
	ORDER_TYPE_POLYLINE   = 0x16 
	ORDER_TYPE_ELLIPSE_SC = 0x19 
	ORDER_TYPE_ELLIPSE_CB = 0x1A 
	ORDER_TYPE_TEXT2      = 0x1B 
)
...
func (o *OrderPdu) processSecondaryOrder(r io.Reader) error {
	...
	default:
		fmt.Println("Unsupport order type 0x")
	}
